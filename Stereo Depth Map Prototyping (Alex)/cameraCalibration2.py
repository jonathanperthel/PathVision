...
#https://stackoverflow.com/questions/42702157/opencv-findchessboardcorners-fails
...
#make sure this actually matches the GRID!!!!!
chessboardSize = (8,5)
frameSize = (640,480)
...
imagesLeft = glob.glob('calibrationFramesA/*.png')
imagesRight = glob.glob('calibrationFramesB/*.png')
